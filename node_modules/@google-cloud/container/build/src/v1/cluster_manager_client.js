...
class ClusterManagerClient {
    ...
    constructor(opts) {
        ...
        this._descriptors.page = {
            listUsableSubnetworks: new gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'subnetworks'),
        };
        // Put together the default options sent with requests.
        const defaults = gaxGrpc.constructSettings('google.container.v1.ClusterManager', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
        ...
        this.clusterManagerStub = gaxGrpc.createStub(opts.fallback
            ? protos.lookupService('google.container.v1.ClusterManager')
            : // tslint:disable-next-line no-any
                protos.google.container.v1.ClusterManager, opts);
